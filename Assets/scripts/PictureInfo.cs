...
public class PictureInfo : MonoBehaviour
{
    ...
    IEnumerator ButtonAnimation()
    {
        ...
        for (;;)
        {
            ...
            {
                _buttonView.transform.GetComponent<Animator>().SetBool("ButtonUsePressed", true);
                pushed = 1;
            }

            if (!Input.GetButton("Use") && pushed == 1 )
            {
                _buttonView.transform.GetComponent<Animator>().SetBool("ButtonUsePressed", false);
                _pictureInfoText.SetActive(!_pictureInfoText.activeInHierarchy);
    ...
    void OnTriggerStay(Collider other)
    {
        if (Input.GetButton("Use"))
        {
            switch (ClousestPicture().name)
            {
                case "Утро в сосновом лесу":
                    _pictureInfoText.transform.GetChild(0).GetComponent<Text>().text =
                    ...
                    break;
                case "Иван Грозный и сын его Иван 16 ноября 1581 года":
                    _pictureInfoText.transform.GetChild(0).GetComponent<Text>().text =
    ...
    {
        _buttonView.SetActive(false);
        _pictureInfoText.SetActive(false);
    }

    void Update()
    {
        _PictureName.GetChild(0).GetComponent<Text>().text = ClousestPicture().name;
    }
